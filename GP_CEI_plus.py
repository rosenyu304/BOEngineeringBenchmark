...
from BoTorch_CEI_plus import ConstrainedExpectedImprovement_plus
...
def get_next_candidates_CEI_plus(X, gx, fx, best_f):
    ...
    cEI_plus = ConstrainedExpectedImprovement_plus(model, best_f, obj_index, constraints)  
    best_candidate, best_eci_value = optimize_acqf(
        acq_function=cEI_plus,
        bounds=bounds,
        q=1,
        num_restarts=1,
        raw_samples=3, 
